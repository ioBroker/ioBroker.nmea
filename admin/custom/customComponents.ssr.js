  ...
  async function getExposesMap() {
    exposesMapPromise ??= import("virtual:mf-exposes-ssr:__mfe_internal__ConfigCustomNmeaSet__customComponents_js").then((mod) => mod.default ?? mod);
  ...
  async function init(shared = {}, initScope = []) {
    const initRes = runtimeInit({
      name: "ConfigCustomNmeaSet",
      remotes: [],
      shared: {},
    });
    const initToken = { from: "ConfigCustomNmeaSet" };
